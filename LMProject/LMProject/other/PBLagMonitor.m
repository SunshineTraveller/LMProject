...
- (void)beginMonitor {
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        while (YES) {
            long semaphoreWait = dispatch_semaphore_wait(self->dispatchSemaphore, dispatch_time(DISPATCH_TIME_NOW, 650 * NSEC_PER_MSEC));
            if (semaphoreWait != 0) {
...
static void runLoopObserverCallBack(CFRunLoopObserverRef observer, CFRunLoopActivity activity, void *info){
    PBLagMonitor *lagMonitor = (__bridge PBLagMonitor*)info;
